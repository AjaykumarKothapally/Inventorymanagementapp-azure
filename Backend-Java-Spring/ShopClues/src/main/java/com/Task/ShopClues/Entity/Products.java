...
@DynamoDBTable(tableName = "Shop_Clues")
public class Products {
	...
	public Products(String id, Long productQty, Long productId, String productSku, String productName,
	...
	public String toString() {
		return "Products [id=" + id + ", productQty=" + productQty + ", productId=" + productId + ", productSku="
